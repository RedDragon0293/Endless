...
object Fonts : ValueRegister, IResourceManagerReloadListener {
    ...
    fun loadFonts() {
        ...
        mcRegular18 = GameFontRenderer(getFont("HarmonyOS_Sans_SC_Regular.ttf", 18), true)
        //mcRegular18 = GameFontRenderer(getFont("Roboto-Regular.ttf", 18), true)
        regular20 = GameFontRenderer(getFont("HarmonyOS_Sans_SC_Regular.ttf", 20))
        ...
        regular24 = GameFontRenderer(getFont("HarmonyOS_Sans_SC_Regular.ttf", 24))
        regular26 = GameFontRenderer(getFont("HarmonyOS_Sans_SC_Regular.ttf", 26))
