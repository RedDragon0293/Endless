...
import cn.asone.endless.event.PostMotionEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        EventManager.INSTANCE.callEvent(new PreMotionEvent());
        boolean flag = this.getSprinting();
        ...
        EventManager.INSTANCE.callEvent(new PostMotionEvent());
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.onGround && !sneak && !forward && this.movementInput.moveForward >= f && !this.getSprinting() && flag3 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness)) {
        ...
        if (!this.getSprinting() && this.movementInput.moveForward >= f && flag3 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }

        if (this.getSprinting() && (this.movementInput.moveForward < f || this.isCollidedHorizontally || !flag3)) {
            this.setSprinting(false);
        }
