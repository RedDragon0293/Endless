...
public class ModelOcelot extends ModelBase {
    ...
    public ModelOcelot() {
        ...
        rendererList.add(ocelotBackLeftLeg);
        rendererList.add(ocelotBackRightLeg);
        rendererList.add(ocelotFrontLeftLeg);
        rendererList.add(ocelotFrontRightLeg);
        rendererList.add(ocelotTail);
        rendererList.add(ocelotTail2);
        rendererList.add(ocelotHead);
        rendererList.add(ocelotBody);
    }
