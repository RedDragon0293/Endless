...
public class ModelHorse extends ModelBase
{
    ...
    public ModelHorse()
    {
        ...
        rendererList.add(upperMouth);
        rendererList.add(lowerMouth);
        rendererList.add(horseLeftEar);
        rendererList.add(horseRightEar);
        rendererList.add(muleLeftEar);
        rendererList.add(muleRightEar);
        rendererList.add(neck);
        rendererList.add(horseFaceRopes);
        rendererList.add(mane);
        rendererList.add(body);
        rendererList.add(tailBase);
        rendererList.add(tailMiddle);
        rendererList.add(tailTip);
        rendererList.add(backLeftLeg);
        rendererList.add(backLeftShin);
        rendererList.add(backLeftHoof);
        rendererList.add(backRightLeg);
        rendererList.add(backRightShin);
        rendererList.add(backRightHoof);
        rendererList.add(frontLeftLeg);
        rendererList.add(frontLeftShin);
        rendererList.add(frontLeftHoof);
        rendererList.add(frontRightLeg);
        rendererList.add(frontRightShin);
        rendererList.add(frontRightHoof);
        rendererList.add(muleLeftChest);
        rendererList.add(muleRightChest);
        rendererList.add(horseSaddleBottom);
        rendererList.add(horseSaddleFront);
        rendererList.add(horseSaddleBack);
        rendererList.add(horseLeftSaddleRope);
        rendererList.add(horseLeftSaddleMetal);
        rendererList.add(horseRightSaddleRope);
        rendererList.add(horseRightSaddleMetal);
        rendererList.add(horseLeftFaceMetal);
        rendererList.add(horseRightFaceMetal);
        rendererList.add(horseLeftRein);
        rendererList.add(horseRightRein);
    }
