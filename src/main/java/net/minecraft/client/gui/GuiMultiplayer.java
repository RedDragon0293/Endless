        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && entry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    this.mc.displayGuiScreen(new GuiYesNo(this, I18n.format("selectServer.deleteQuestion"), "'" + s4 + "' " + I18n.format("selectServer.deleteWarning"), I18n.format("selectServer.deleteButton"), I18n.format("gui.cancel"), this.serverListSelector.func_148193_k()));
                }
            } else if (button.id == 1) {
