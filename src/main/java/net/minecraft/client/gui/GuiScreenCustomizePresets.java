...
public class GuiScreenCustomizePresets extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.field_175317_i = new GuiTextField(2, mc.fontRendererObj, 50, 40, this.width - 100, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(mc.fontRendererObj, this.field_175315_a, this.width / 2, 8, 16777215);
        this.drawString(mc.fontRendererObj, this.field_175313_s, 50, 30, 10526880);
        this.drawString(mc.fontRendererObj, this.field_175312_t, 50, 70, 10526880);
