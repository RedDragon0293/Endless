...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void sendChatMessage(String msg, boolean addToChat) {
        ...
        if (msg.startsWith(CommandManager.INSTANCE.getPrefix()) && addToChat) {
            /*
              传参至CommandManager时去除开头prefix
             */
            CommandManager.INSTANCE.executeCommand(msg.substring(1));
            return;
        }
    ...
    private void openWebLink(URI link) {
        try {
    ...
    public static boolean isKeyComboCtrlX(int keyCode) {
        return keyCode == 45 && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlV(int keyCode) {
        return keyCode == 47 && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlC(int keyCode) {
        return keyCode == 46 && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlA(int keyCode) {
        return keyCode == 30 && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }
