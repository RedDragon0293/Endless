...
public class GuiCommandBlock extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.commandTextField = new GuiTextField(2, mc.fontRendererObj, this.width / 2 - 150, 50, 300, 20);
        this.commandTextField.setMaxStringLength(32767);
        this.commandTextField.setFocused(true);
        this.commandTextField.setText(this.localCommandBlock.getCommand());
        this.previousOutputTextField = new GuiTextField(3, mc.fontRendererObj, this.width / 2 - 150, 150, 276, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(mc.fontRendererObj, I18n.format("advMode.setCommand", new Object[0]), this.width / 2, 20, 16777215);
        this.drawString(mc.fontRendererObj, I18n.format("advMode.command", new Object[0]), this.width / 2 - 150, 37, 10526880);
        this.commandTextField.drawTextBox();
        int i = 75;
        int j = 0;
        this.drawString(mc.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), this.width / 2 - 150, i + j++ * mc.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(mc.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150, i + j++ * mc.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(mc.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), this.width / 2 - 150, i + j++ * mc.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(mc.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), this.width / 2 - 150, i + j++ * mc.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(mc.fontRendererObj, "", this.width / 2 - 150, i + j++ * mc.fontRendererObj.FONT_HEIGHT, 10526880);

        if (this.previousOutputTextField.getText().length() > 0)
        {
            i = i + j * mc.fontRendererObj.FONT_HEIGHT + 16;
            this.drawString(mc.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), this.width / 2 - 150, i, 10526880);
