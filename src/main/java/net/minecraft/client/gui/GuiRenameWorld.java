...
public class GuiRenameWorld extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.field_146583_f = new GuiTextField(2, mc.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(mc.fontRendererObj, I18n.format("selectWorld.renameTitle", new Object[0]), this.width / 2, 20, 16777215);
        this.drawString(mc.fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 47, 10526880);
