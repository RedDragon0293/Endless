...
public class GuiStats extends GuiScreen implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        if (this.doesGuiPauseGame)
        {
            ...
            this.drawCenteredString(mc.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
            this.drawCenteredString(mc.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], this.width / 2, this.height / 2 + mc.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else
        {
            this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
            this.drawCenteredString(mc.fontRendererObj, this.screenTitle, this.width / 2, 20, 16777215);
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
        {
            if (p_148209_1_ != null)
            {
                ...
                GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s, p_148209_2_ - GuiStats.this.mc.fontRendererObj.getStringWidth(s), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
            else
            {
                String s1 = "-";
                GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s1, p_148209_2_ - GuiStats.this.mc.fontRendererObj.getStringWidth(s1), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
        }
            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom)
            {
                ...
                else
                {
                    ...
                    if (s.length() > 0)
                    {
                        ...
                        int i1 = GuiStats.this.mc.fontRendererObj.getStringWidth(s);
                        GuiStats.this.drawGradientRect(k - 3, l - 3, k + i1 + 3, l + 8 + 3, -1073741824, -1073741824);
                        GuiStats.this.mc.fontRendererObj.drawStringWithShadow(s, (float)k, (float)l, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
        {
            if (p_148213_1_ != null)
            {
                ...
                if (s1.length() > 0)
                {
                    ...
                    int k = GuiStats.this.mc.fontRendererObj.getStringWidth(s1);
                    GuiStats.this.drawGradientRect(i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
                    GuiStats.this.mc.fontRendererObj.drawStringWithShadow(s1, (float)i, (float)j, -1);
                }
            }
        }
    ...
    class StatsBlock extends GuiStats.Stats
    {
        ...
        protected void drawSlot(int entryID, int posX, int posY, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawStatsScreen(posX + 40, posY, item);
            int i = Item.getIdFromItem(item);
            this.func_148209_a(StatList.objectCraftStats[i], posX + 115, posY, entryID % 2 == 0);
            this.func_148209_a(StatList.objectUseStats[i], posX + 165, posY, entryID % 2 == 0);
            this.func_148209_a(statcrafting, posX + 215, posY, entryID % 2 == 0);
        }
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int posX, int posY, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, statbase.getStatName().getUnformattedText(), posX + 2, posY + 1, entryID % 2 == 0 ? 16777215 : 9474192);
            String s = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s, posX + 2 + 213 - GuiStats.this.mc.fontRendererObj.getStringWidth(s), posY + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsItem extends GuiStats.Stats
    {
        ...
        protected void drawSlot(int entryID, int posX, int posY, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawStatsScreen(posX + 40, posY, item);
            int i = Item.getIdFromItem(item);
            this.func_148209_a(StatList.objectBreakStats[i], posX + 115, posY, entryID % 2 == 0);
            this.func_148209_a(StatList.objectCraftStats[i], posX + 165, posY, entryID % 2 == 0);
            this.func_148209_a(statcrafting, posX + 215, posY, entryID % 2 == 0);
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        {
            super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.this.mc.fontRendererObj.FONT_HEIGHT * 4);
            this.setShowSelectionBox(false);
        ...
        protected int getContentHeight()
        {
            return this.getSize() * GuiStats.this.mc.fontRendererObj.FONT_HEIGHT * 4;
        }
        ...
        protected void drawSlot(int entryID, int posX, int posY, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s, posX + 2 - 10, posY + 1, 16777215);
            GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s1, posX + 2, posY + 1 + GuiStats.this.mc.fontRendererObj.FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.mc.fontRendererObj, s2, posX + 2, posY + 1 + GuiStats.this.mc.fontRendererObj.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
        }
    }
}
