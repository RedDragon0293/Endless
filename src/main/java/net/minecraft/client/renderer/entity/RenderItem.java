...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private void draw(WorldRenderer worldRenderer, int x, int y, int width, int height, int colorRed, int colorGreen, int colorBlue, int colorAlpha) {
        worldRenderer.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_COLOR);
        worldRenderer.pos(x, y, 0.0D).color(colorRed, colorGreen, colorBlue, colorAlpha).endVertex();
        worldRenderer.pos(x, y + height, 0.0D).color(colorRed, colorGreen, colorBlue, colorAlpha).endVertex();
        worldRenderer.pos(x + width, y + height, 0.0D).color(colorRed, colorGreen, colorBlue, colorAlpha).endVertex();
        worldRenderer.pos(x + width, y, 0.0D).color(colorRed, colorGreen, colorBlue, colorAlpha).endVertex();
