...
public abstract class World implements IBlockAccess {
    ...
    protected void playMoodSoundAndCheckLight(int p_147467_1_, int p_147467_2_, Chunk chunkIn) {
        ...
        if (this.ambientTickCountdown == 0 && !this.isRemote) {
            ...
            if (block.getMaterial() == Material.air && this.getLight(blockpos) <= this.rand.nextInt(8) && this.getLightFor(EnumSkyBlock.SKY, worldpos) <= 0) //Forge: fix arguments to world positions instead of chunk position
            {
