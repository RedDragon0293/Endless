...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
    ...
    public void update() {
        ...
        if (this.playerEntity.getLastActiveTime() > 0L && this.serverController.getMaxPlayerIdleMinutes() > 0 && MinecraftServer.getCurrentTimeMillis() - this.playerEntity.getLastActiveTime() > (this.serverController.getMaxPlayerIdleMinutes() * 1000L * 60L)) {
    ...
    private boolean isInvalidMovePacket(C03PacketPlayer packet) {
    ...
    public void processPlayer(C03PacketPlayer packetIn) {
        ...
        if (this.isInvalidMovePacket(packetIn)) {
