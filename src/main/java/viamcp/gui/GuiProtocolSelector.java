...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawString(mc.fontRendererObj, title, (this.width - (mc.fontRendererObj.getStringWidth(title) * 2)) / 4, 5, -1);
        ...
        drawString(mc.fontRendererObj, EnumChatFormatting.GRAY + (EnumChatFormatting.BOLD + "Version Information"), (width - mc.fontRendererObj.getStringWidth("Version Information")) / 2, fixedHeight, -1);
        drawString(mc.fontRendererObj, versionTitle, (width - mc.fontRendererObj.getStringWidth(versionTitle)) / 2, fixedHeight + mc.fontRendererObj.FONT_HEIGHT, -1);
        drawString(mc.fontRendererObj, versionReleased, (width - mc.fontRendererObj.getStringWidth(versionReleased)) / 2, fixedHeight + mc.fontRendererObj.FONT_HEIGHT * 2, -1);
