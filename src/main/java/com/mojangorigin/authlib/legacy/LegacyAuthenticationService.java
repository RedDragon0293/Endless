package com.mojangorigin.authlib.legacy;

import com.mojangorigin.authlib.Agent;
import com.mojangorigin.authlib.GameProfileRepository;
...
public class LegacyAuthenticationService extends HttpAuthenticationService {
    ...
    /**
     * Creates a relevant {@link com.mojangorigin.authlib.UserAuthentication} using the legacy servers.
     * <p />
     * The legacy authentication service only supports the Minecraft {@link Agent}.
     *
