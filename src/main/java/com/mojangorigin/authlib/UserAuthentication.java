...
public interface UserAuthentication {
     ...
     * and that username is valid but migrated to a Mojang account ("steve@minecraft.net"), a {@link com.mojangorigin.authlib.exceptions.UserMigratedException}
     * will be thrown.
     *
     ...
     * @throws com.mojangorigin.authlib.exceptions.InvalidCredentialsException Thrown when the specified credentials are invalid
     * @throws com.mojangorigin.authlib.exceptions.UserMigratedException Thrown when attempting to authenticate with a {@link #setUsername(String) username} that has been migrated to an email address
     ...
     * @throws com.mojangorigin.authlib.exceptions.AuthenticationException User is not currently {@link #isLoggedIn() logged in},
     ...
     * <p />
     * This may be used to load an approximation of the current state from a past {@link com.mojangorigin.authlib.UserAuthentication} with {@link #saveForStorage()}.
     *
     ...
     * <p />
     * This may be used to save an approximation of the current state for a future {@link com.mojangorigin.authlib.UserAuthentication} with {@link #loadFromStorage(java.util.Map)}.
     *
